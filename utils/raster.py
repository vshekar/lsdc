...
def get_raster_result_matrix(raster_cell_result, raster_def):
    spot_count_list = [res["spot_count"] for res in raster_cell_result]

    return create_snake_array(spot_count_list, *determine_raster_shape(raster_def)) 